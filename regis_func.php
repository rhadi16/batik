<?php 
	...
	if ($jum_data >= 1) {
		...
		$result = mysqli_query($mysqli, "INSERT INTO pelanggan (id_pelanggan, email, password, nama_pelanggan, no_hp) 
										VALUES(null, '$email', '$password', '$nama_pelanggan', '$no_hp')") or die(mysqli_error($mysqli));
