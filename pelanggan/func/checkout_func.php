<?php 
	...
	if ($action == "insert") {
		...
		$kum_jum_dibeli	= $_POST['jum_dibeli'];
		...
		if (move_uploaded_file($tmp_file, $path)) {
			$result = mysqli_query($mysqli, "INSERT INTO check_out (id_checkout, id_pelanggan, id_barang, jum_dibeli, total_harga, bayar_via, foto_bukti_tf, status_pesanan, tgl_pesan) 
											 VALUES('$id_checkout', '$id_pelanggan', '$id_barang', '$jum_dibeli', '$total_harga', '$bayar_via', '$foto', '$status_pesanan', '$tgl_pesan')") or die(mysqli_error($mysqli));
