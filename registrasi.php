...
<body>
  ...
  <div class="my-container">
    ...
    <nav class="navbar top-navbar px-5">
      <a class="btn border-0" id="title"><h5>Batik Indonesia</h5></a>
      <div class="info">
    ...
    <main>
      <div class="container">
        <form method="post" action="regis_func.php">
          <div class="form">
            <img src="img/batik.png" class="logo-regis mb-3 mt-5">
            <div class="mb-3">
            ...
            <div class="mb-3">
              <input type="text" class="form-control" id="nama_pelanggan" placeholder="Nama Pelanggan" required name="nama_pelanggan">
            </div>
            <div class="mb-3">
              <input type="text" class="form-control" id="no_hp" placeholder="Nomor HP/WA Pelanggan" required name="no_hp">
            </div>
